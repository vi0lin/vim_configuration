...
nnoremap <F5> :call SetMode("\<F5\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <F5> :call SetMode("\<F5\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <F5> :call SetMode("\<F5\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <A-F5> :call SetMode("\<A-F5\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <A-F5> :call SetMode("\<A-F5\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <A-F5> :call SetMode("\<A-F5\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <S-F5> :call SetMode("\<S-F5\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <S-F5> :call SetMode("\<S-F5\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <S-F5> :call SetMode("\<S-F5\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <S-A-F5> :call SetMode("\<S-A-F5\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <S-A-F5> :call SetMode("\<S-A-F5\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <S-A-F5> :call SetMode("\<S-A-F5\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <C-F5> :call SetMode("\<C-F5\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <C-F5> :call SetMode("\<C-F5\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <C-F5> :call SetMode("\<C-F5\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <C-A-F5> :call SetMode("\<C-A-F5\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <C-A-F5> :call SetMode("\<C-A-F5\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <C-A-F5> :call SetMode("\<C-A-F5\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <C-S-F5> :call SetMode("\<C-S-F5\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <C-S-F5> :call SetMode("\<C-S-F5\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <C-S-F5> :call SetMode("\<C-S-F5\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <C-S-A-F5> :call SetMode("\<C-S-A-F5\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <C-S-A-F5> :call SetMode("\<C-S-A-F5\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <C-S-A-F5> :call SetMode("\<C-S-A-F5\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap ,<F5> :call SetMode(",\<F5\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap ,<F5> :call SetMode(",\<F5\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap ,<F5> :call SetMode(",\<F5\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap ,<A-F5> :call SetMode(",\<A-F5\>", "Normal") \| :call Keypress_Handler()<cr>
...
vnoremap ,,,,,<C-S-A-F5> :call SetMode(",,,,,\<C-S-A-F5\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap ,,,,,<C-S-A-F5> :call SetMode(",,,,,\<C-S-A-F5\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <F6> :call SetMode("\<F6\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <F6> :call SetMode("\<F6\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <F6> :call SetMode("\<F6\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <A-F6> :call SetMode("\<A-F6\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <A-F6> :call SetMode("\<A-F6\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <A-F6> :call SetMode("\<A-F6\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <S-F6> :call SetMode("\<S-F6\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <S-F6> :call SetMode("\<S-F6\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <S-F6> :call SetMode("\<S-F6\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <S-A-F6> :call SetMode("\<S-A-F6\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <S-A-F6> :call SetMode("\<S-A-F6\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <S-A-F6> :call SetMode("\<S-A-F6\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <C-F6> :call SetMode("\<C-F6\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <C-F6> :call SetMode("\<C-F6\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <C-F6> :call SetMode("\<C-F6\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <C-A-F6> :call SetMode("\<C-A-F6\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <C-A-F6> :call SetMode("\<C-A-F6\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <C-A-F6> :call SetMode("\<C-A-F6\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <C-S-F6> :call SetMode("\<C-S-F6\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <C-S-F6> :call SetMode("\<C-S-F6\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <C-S-F6> :call SetMode("\<C-S-F6\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <C-S-A-F6> :call SetMode("\<C-S-A-F6\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <C-S-A-F6> :call SetMode("\<C-S-A-F6\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <C-S-A-F6> :call SetMode("\<C-S-A-F6\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap ,<F6> :call SetMode(",\<F6\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap ,<F6> :call SetMode(",\<F6\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap ,<F6> :call SetMode(",\<F6\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap ,<A-F6> :call SetMode(",\<A-F6\>", "Normal") \| :call Keypress_Handler()<cr>
...
vnoremap ,,,,,<C-S-A-F6> :call SetMode(",,,,,\<C-S-A-F6\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap ,,,,,<C-S-A-F6> :call SetMode(",,,,,\<C-S-A-F6\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <F7> :call SetMode("\<F7\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <F7> :call SetMode("\<F7\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <F7> :call SetMode("\<F7\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <A-F7> :call SetMode("\<A-F7\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <A-F7> :call SetMode("\<A-F7\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <A-F7> :call SetMode("\<A-F7\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <S-F7> :call SetMode("\<S-F7\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <S-F7> :call SetMode("\<S-F7\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <S-F7> :call SetMode("\<S-F7\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <S-A-F7> :call SetMode("\<S-A-F7\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <S-A-F7> :call SetMode("\<S-A-F7\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <S-A-F7> :call SetMode("\<S-A-F7\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <C-F7> :call SetMode("\<C-F7\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <C-F7> :call SetMode("\<C-F7\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <C-F7> :call SetMode("\<C-F7\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <C-A-F7> :call SetMode("\<C-A-F7\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <C-A-F7> :call SetMode("\<C-A-F7\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <C-A-F7> :call SetMode("\<C-A-F7\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <C-S-F7> :call SetMode("\<C-S-F7\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <C-S-F7> :call SetMode("\<C-S-F7\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <C-S-F7> :call SetMode("\<C-S-F7\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <C-S-A-F7> :call SetMode("\<C-S-A-F7\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <C-S-A-F7> :call SetMode("\<C-S-A-F7\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <C-S-A-F7> :call SetMode("\<C-S-A-F7\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap ,<F7> :call SetMode(",\<F7\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap ,<F7> :call SetMode(",\<F7\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap ,<F7> :call SetMode(",\<F7\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap ,<A-F7> :call SetMode(",\<A-F7\>", "Normal") \| :call Keypress_Handler()<cr>
...
vnoremap ,,,,,<C-S-A-F7> :call SetMode(",,,,,\<C-S-A-F7\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap ,,,,,<C-S-A-F7> :call SetMode(",,,,,\<C-S-A-F7\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <F8> :call SetMode("\<F8\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <F8> :call SetMode("\<F8\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <F8> :call SetMode("\<F8\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <A-F8> :call SetMode("\<A-F8\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <A-F8> :call SetMode("\<A-F8\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <A-F8> :call SetMode("\<A-F8\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <S-F8> :call SetMode("\<S-F8\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <S-F8> :call SetMode("\<S-F8\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <S-F8> :call SetMode("\<S-F8\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <S-A-F8> :call SetMode("\<S-A-F8\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <S-A-F8> :call SetMode("\<S-A-F8\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <S-A-F8> :call SetMode("\<S-A-F8\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <C-F8> :call SetMode("\<C-F8\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <C-F8> :call SetMode("\<C-F8\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <C-F8> :call SetMode("\<C-F8\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <C-A-F8> :call SetMode("\<C-A-F8\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <C-A-F8> :call SetMode("\<C-A-F8\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <C-A-F8> :call SetMode("\<C-A-F8\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <C-S-F8> :call SetMode("\<C-S-F8\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <C-S-F8> :call SetMode("\<C-S-F8\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <C-S-F8> :call SetMode("\<C-S-F8\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap <C-S-A-F8> :call SetMode("\<C-S-A-F8\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap <C-S-A-F8> :call SetMode("\<C-S-A-F8\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap <C-S-A-F8> :call SetMode("\<C-S-A-F8\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap ,<F8> :call SetMode(",\<F8\>", "Normal") \| :call Keypress_Handler()<cr>
vnoremap ,<F8> :call SetMode(",\<F8\>", "Visual") \| '<,'>:call Keypress_Handler()<cr>
cnoremap ,<F8> :call SetMode(",\<F8\>", "Command") \| :call Keypress_Handler()<cr>
nnoremap ,<A-F8> :call SetMode(",\<A-F8\>", "Normal") \| :call Keypress_Handler()<cr>
...
tnoremap <C-k> k
tnoremap <C-j> j
inoremap <C-l> <C-\><C-n>:call SetMode("\<C-l\>", "Insert") \| <C-w>li
inoremap <C-h> <C-\><C-n>:call SetMode("\<C-h\>", "Insert") \| <C-w>hi
inoremap <c-w><c-w> <C-\><C-n>:call SetMode("\<c-w\>\<c-w\>", "Insert") \| <c-w><c-w>
tnoremap  <C-\><C-n>:call SetMode("", "Terminal") \| :call ExitTerminal()<cr>
inoremap <A-'> <C-\><C-n>:call SetMode("\<A-'\>", "Insert") \| ä
inoremap <A-"> <C-\><C-n>:call SetMode("\<A-"\>", "Insert") \| Ä
inoremap <A-;> <C-\><C-n>:call SetMode("\<A-;\>", "Insert") \| ö
inoremap <A-:> <C-\><C-n>:call SetMode("\<A-:\>", "Insert") \| Ö
inoremap <A-[> <C-\><C-n>:call SetMode("\<A-[\>", "Insert") \| ü
inoremap <A-{> <C-\><C-n>:call SetMode("\<A-{\>", "Insert") \| Ü
inoremap <A--> <C-\><C-n>:call SetMode("\<A--\>", "Insert") \| ß
...
inoremap <C-s> <C-\><C-n>:call SetMode("\<C-s\>", "Insert") \| :call SaveFile()<cr>
...
inoremap <C-F12> <C-\><C-n>:call SetMode("\<C-F12\>", "Insert") \| :call Commands()<cr>
nnoremap <C-F12> :call SetMode("\<C-F12\>", "Normal") \| :call Commands()<cr>
vnoremap <C-F12> :call SetMode("\<C-F12\>", "Visual") \| '<,'>:call Commands()<cr>
cnoremap <C-F12> :call SetMode("\<C-F12\>", "Command") \| :call Commands()<cr>
tnoremap <C-F12> <C-\><C-n>:call SetMode("\<C-F12\>", "Terminal") \| :call Commands()<cr>
...
inoremap <C-S-F12> <C-\><C-n>:call SetMode("\<C-S-F12\>", "Insert") \| :call Commands()<cr>
nnoremap <C-S-F12> :call SetMode("\<C-S-F12\>", "Normal") \| :call Commands()<cr>
vnoremap <C-S-F12> :call SetMode("\<C-S-F12\>", "Visual") \| '<,'>:call Commands()<cr>
cnoremap <C-S-F12> :call SetMode("\<C-S-F12\>", "Command") \| :call Commands()<cr>
tnoremap <C-S-F12> <C-\><C-n>:call SetMode("\<C-S-F12\>", "Terminal") \| :call Commands()<cr>
...
inoremap <A-F12> <C-\><C-n>:call SetMode("\<A-F12\>", "Insert") \| :call Commands()<cr>
nnoremap <A-F12> :call SetMode("\<A-F12\>", "Normal") \| :call Commands()<cr>
vnoremap <A-F12> :call SetMode("\<A-F12\>", "Visual") \| '<,'>:call Commands()<cr>
cnoremap <A-F12> :call SetMode("\<A-F12\>", "Command") \| :call Commands()<cr>
tnoremap <A-F12> <C-\><C-n>:call SetMode("\<A-F12\>", "Terminal") \| :call Commands()<cr>
...
inoremap <A-S-F12> <C-\><C-n>:call SetMode("\<A-S-F12\>", "Insert") \| :call Commands()<cr>
nnoremap <A-S-F12> :call SetMode("\<A-S-F12\>", "Normal") \| :call Commands()<cr>
vnoremap <A-S-F12> :call SetMode("\<A-S-F12\>", "Visual") \| '<,'>:call Commands()<cr>
cnoremap <A-S-F12> :call SetMode("\<A-S-F12\>", "Command") \| :call Commands()<cr>
tnoremap <A-S-F12> <C-\><C-n>:call SetMode("\<A-S-F12\>", "Terminal") \| :call Commands()<cr>
...
inoremap <A-C-F12> <C-\><C-n>:call SetMode("\<A-C-F12\>", "Insert") \| :call Commands()<cr>
nnoremap <A-C-F12> :call SetMode("\<A-C-F12\>", "Normal") \| :call Commands()<cr>
vnoremap <A-C-F12> :call SetMode("\<A-C-F12\>", "Visual") \| '<,'>:call Commands()<cr>
cnoremap <A-C-F12> :call SetMode("\<A-C-F12\>", "Command") \| :call Commands()<cr>
tnoremap <A-C-F12> <C-\><C-n>:call SetMode("\<A-C-F12\>", "Terminal") \| :call Commands()<cr>
...
inoremap <A-S-C-F12> <C-\><C-n>:call SetMode("\<A-S-C-F12\>", "Insert") \| :call Commands()<cr>
nnoremap <A-S-C-F12> :call SetMode("\<A-S-C-F12\>", "Normal") \| :call Commands()<cr>
vnoremap <A-S-C-F12> :call SetMode("\<A-S-C-F12\>", "Visual") \| '<,'>:call Commands()<cr>
cnoremap <A-S-C-F12> :call SetMode("\<A-S-C-F12\>", "Command") \| :call Commands()<cr>
tnoremap <A-S-C-F12> <C-\><C-n>:call SetMode("\<A-S-C-F12\>", "Terminal") \| :call Commands()<cr>
...
inoremap <C-Space> <C-\><C-n>:call SetMode("\<C-Space\>", "Insert") \| <C-x><C-f>
inoremap <C-S-v> <C-\><C-n>:call SetMode("\<C-S-v\>", "Insert") \| <c-r>+
