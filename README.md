...
<strike>
```
apt-get install -y kitty libwayland-cursor0 libwayland-dev libwayland-egl1dbus-x11 libegl1 libegl-mesa0 libgles2 libwayland-cursor0 libwayland-dev libwayland-egl1
kitty
```
</strike>
