...
NewCommand command -range -nargs=+ Nnoremap <line1>,<line2>call Nnoremap(<f-args>)
NewCommand command -range -nargs=+ Vnoremap <line1>,<line2>call Vnoremap(<f-args>)
NewCommand command -range -nargs=+ Inoremap <line1>,<line2>call Inoremap(<f-args>)
NewCommand command -range -nargs=+ Tnoremap <line1>,<line2>call Tnoremap(<f-args>)
NewCommand command -range -nargs=+ TnoremapInsertmode <line1>,<line2>call TnoremapInsertmode(<f-args>)
NewCommand command -range -nargs=+ Cnoremap <line1>,<line2>call Cnoremap(<f-args>)
NewCommand command -range -nargs=+ Anoremap <line1>,<line2>call Anoremap(<f-args>)
...
NewCommand command -range -nargs=+ TmapInsertmode <line1>,<line2>call TmapInsertmode(<f-args>)
